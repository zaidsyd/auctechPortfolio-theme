...
include '../db_con.php';
$que = "SELECT * FROM add_year_master WHERE id = $user_id";
                ...
                <div class="col-xl-6 col-xxl-12 col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Update Year Master</h4>
                        </div>
                        <hr>
                        <div class="card-body">
                            <div class="basic-form">
                                <form method="POST" action="year_master_update.php" enctype="multipart/form-data">
                                    <div class="form-row">
