...
include '../db_con.php';
$que = "SELECT * FROM add_industry_master WHERE id = $user_id";
                ...
                <div class="col-xl-6 col-xxl-12 col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Update Industry Master</h4>
                        </div>
                        <hr>
                        <div class="card-body">
                            <div class="basic-form">
                                <form method="POST" action="industry_master_update.php" enctype="multipart/form-data">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label>Industry Name</label>
                                            <input type="text" name='industry_name' id="industry_name"
                                                class="form-control"
                                                value="<?php echo htmlspecialchars($row['industry_name']); ?>">
                                        </div>
